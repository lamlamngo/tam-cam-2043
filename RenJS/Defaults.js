var defaults = {
    ...
    positions : {
        ...
        OUTLEFT: {x:-(globalConfig.w/6),y:globalConfig.h/2 - 16},
        CENTERCHAR: {x:globalConfig.w/2,y:globalConfig.h/2 - 16},
        ...
        OUTRIGHT: {x:(globalConfig.w/6)*7,y:globalConfig.h/2 - 16},
